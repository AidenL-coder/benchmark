...
own evaluation. Section~\ref{sec:repro} reports separately on executing the
\emph{proposal} half of the same system, where six defects had to be repaired
before a scaffold variant could be generated at all, and where four of the six
were reported through the same channel as ordinary model failure. That
observation is a smaller contribution than the measurement result, but it
bears on the same question: whether the quantities these systems record can
